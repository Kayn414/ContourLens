...
This file provides guidance to Claude Code (claude.ai/code) and to anyone who
clones this repository: what the pieces are, how to run them, and how to find
your way around the GUI.
